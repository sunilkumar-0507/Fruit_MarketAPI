...
public sealed record ProductUpsertRequest(string NameEn, string NameTa, string? DescriptionEn, string? DescriptionTa, string? AboutEn, string? AboutTa, string? UsageEn, string? UsageTa, string? BenefitsEn, string? BenefitsTa, decimal Price, int StockQuantity, Guid CategoryId, IReadOnlyList<ProductImageRequest>? Images, bool IsOutOfStock = false);
