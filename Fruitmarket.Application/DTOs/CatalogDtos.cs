...
public sealed record ProductDto(Guid Id, string NameEn, string NameTa, string Slug, string? DescriptionEn, string? DescriptionTa, string? AboutEn, string? AboutTa, string? UsageEn, string? UsageTa, string? BenefitsEn, string? BenefitsTa, decimal Price, decimal? OriginalPrice, decimal StockQuantity, bool IsOutOfStock, CategoryDto? Category, IReadOnlyList<ProductImageDto> Images, double Rating);
public sealed record ProductImageDto(Guid Id, string Url, string? AltText, bool IsPrimary);
public sealed record ProductUpsertRequest(string NameEn, string NameTa, string? DescriptionEn, string? DescriptionTa, string? AboutEn, string? AboutTa, string? UsageEn, string? UsageTa, string? BenefitsEn, string? BenefitsTa, decimal Price, decimal StockQuantity, Guid CategoryId, IReadOnlyList<ProductImageRequest>? Images, bool IsOutOfStock = false);
